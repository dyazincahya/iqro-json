...
def run_ocr():
    ...
    image_path = os.path.join(base_dir, "iqro-images", "2", "2-1.png")
    output_dir = os.path.join(base_dir, "iqro", "2")
    output_path = os.path.join(output_dir, "2-1.json")
    
    print(f"Reading image: {image_path}")
    reader = easyocr.Reader(['ar', 'en'], gpu=False)
    
    temp_image = "temp_2-1.png"
    ...
    reference_content = [{"order_id": 1, "latin": "BATA = BADA = BADA", "arabic": "بَتَ = بَ دَ = بَ دَ"}, {"order_id": 2, "latin": "TAR = TAR = TARU = TARU", "arabic": "تَر = تَر = تَرَ وُ = تَر وُ"}, {"order_id": 3, "latin": "TATA TADA TABA TAWU", "arabic": "تَتَ    تَدَ    تَبَ    تَوُ"}, {"order_id": 4, "latin": "BABA BADZA BATA TAZA", "arabic": "بَبَ    بَذَ    بَتَ    تَزَ"}, {"order_id": 5, "latin": "BATHA TADZA THATA ZATHA", "arabic": "بَثَ    تَذَ    ثَتَ    زَثَ"}, {"order_id": 6, "latin": "BA'A BAATA TA'A TAATA", "arabic": "بَأَ    بَاتَ    تَأَ    تَاتَ"}, {"order_id": 7, "latin": "THABA THARU BARU TAWA", "arabic": "ثَبَ    ثَرُ    بَرُ    تَوَ"}, {"order_id": 8, "latin": "TOHA JAKA KAY JASA", "arabic": "طَهَ    جَكَ    كَى    جَسَ"}]
