...
def run_ocr():
    ...
    image_path = os.path.join(base_dir, "iqro-images", "1", "1-28.png")
    output_dir = os.path.join(base_dir, "iqro", "1")
    output_path = os.path.join(output_dir, "1-28.json")
    
    print(f"Reading image: {image_path}")
    reader = easyocr.Reader(['ar', 'en'], gpu=False)
    
    temp_image = "temp_1-28.png"
    ...
    iqro_data = {
        "level_id": 1,
        "level_title": "IQRO' 1",
        "topic": {"latin": "A (Alif & Hamzah), Ra, Mim", "arab": "اَ (ا, ء), رَ, مَ"},
        "instruction_id": "",
        "instruction_en": "",
        "instruction_ar": "",
        "content": []
    ...
    reference_content = [{"order_id": 1, "latin": "BA RA A", "arabic": "بَ رَ اَ"}, {"order_id": 2, "latin": "BA RA MA", "arabic": "بَ رَ مَ"}, {"order_id": 3, "latin": "QOF RA A", "arabic": "قَ رَ اَ"}, {"order_id": 4, "latin": "A MA RA", "arabic": "اَ مَ رَ"}, {"order_id": 5, "latin": "JA MA RA A", "arabic": "جَ مَ رَ اَ"}, {"order_id": 6, "latin": "SA A LA", "arabic": "سَ اَ لَ"}, {"order_id": 7, "latin": "RA ZA QOF", "arabic": "رَ زَ قَ"}, {"order_id": 8, "latin": "MA DA HA", "arabic": "مَ دَ حَ"}, {"order_id": 9, "latin": "GHA MA RA MA", "arabic": "غَ مَ رَ مَ"}, {"order_id": 10, "latin": "LI A KA", "arabic": "لِ اَ كَ"}, {"order_id": 11, "latin": "MA RA SYA A", "arabic": "مَ رَ شَ اَ"}, {"order_id": 12, "latin": "MA RA DA MA", "arabic": "مَ رَ دَ مَ"}, {"order_id": 13, "latin": "SA YI I", "arabic": "سَ ي اِ"}, {"order_id": 14, "latin": "JA KA LA", "arabic": "جَ كَ لَ"}, {"order_id": 15, "latin": "KA YI", "arabic": "كَ ي"}, {"order_id": 16, "latin": "QOF TA LA MA SA NA", "arabic": "قَ تَ لَ مَ سَ نَ"}]
