...
def run_ocr():
    ...
    image_path = os.path.join(base_dir, "iqro-images", "1", "1-4.png")
    output_dir = os.path.join(base_dir, "iqro", "1")
    output_path = os.path.join(output_dir, "1-4.json")
    
    print(f"Reading image: {image_path}")
    reader = easyocr.Reader(['ar', 'en'], gpu=False)
    
    temp_image = "temp_1-4.png"
    ...
    reference_content = [{"order_id": 1, "latin": "A TSA JA", "arabic": "اَ ثَ جَ"}, {"order_id": 2, "latin": "JA JA", "arabic": "جَ جَ"}, {"order_id": 3, "latin": "A TSA BA JA", "arabic": "اَ ثَ بَ جَ"}, {"order_id": 4, "latin": "JA TSA", "arabic": "جَ ثَ"}, {"order_id": 5, "latin": "BA A TSA JA", "arabic": "بَ اَ ثَ جَ"}, {"order_id": 6, "latin": "JA A BA", "arabic": "جَ اَ بَ"}, {"order_id": 7, "latin": "JA TSA JA", "arabic": "جَ ثَ جَ"}, {"order_id": 8, "latin": "JA JA A", "arabic": "جَ جَ اَ"}, {"order_id": 9, "latin": "A BA TSA JA", "arabic": "اَ بَ ثَ جَ"}, {"order_id": 10, "latin": "A JA JA", "arabic": "اَ جَ جَ"}, {"order_id": 11, "latin": "A TSA TSA JA", "arabic": "اَ ثَ ثَ جَ"}, {"order_id": 12, "latin": "A BA TSA JA", "arabic": "اَ بَ ثَ جَ"}, {"order_id": 13, "latin": "A BA TSA JA", "arabic": "اَ بَ ثَ جَ"}]
