...
def run_ocr():
    ...
    image_path = os.path.join(base_dir, "iqro-images", "1", "1-8.png")
    output_dir = os.path.join(base_dir, "iqro", "1")
    output_path = os.path.join(output_dir, "1-8.json")
    
    print(f"Reading image: {image_path}")
    reader = easyocr.Reader(['ar', 'en'], gpu=False)
    
    temp_image = "temp_1-8.png"
    ...
    reference_content = [{"order_id": 1, "latin": "DZA DZA", "arabic": "ذَ ذَ"}, {"order_id": 2, "latin": "DZA DZA DA", "arabic": "ذَ ذَ دَ"}, {"order_id": 3, "latin": "DZA DA DA", "arabic": "ذَ دَ دَ"}, {"order_id": 4, "latin": "DZA DA KHO", "arabic": "ذَ دَ خَ"}, {"order_id": 5, "latin": "DZA DA TSA", "arabic": "ذَ دَ ثَ"}, {"order_id": 6, "latin": "DZA DA TA", "arabic": "ذَ دَ تَ"}, {"order_id": 7, "latin": "DZA DA BA", "arabic": "ذَ دَ بَ"}, {"order_id": 8, "latin": "DZA DA A", "arabic": "ذَ دَ أَ"}, {"order_id": 9, "latin": "DZA DA KHO", "arabic": "ذَ دَ خَ"}, {"order_id": 10, "latin": "DZA DA DA", "arabic": "ذَ دَ دَ"}, {"order_id": 11, "latin": "A BA TA TSA", "arabic": "أَ بَ تَ ثَ"}, {"order_id": 12, "latin": "JA HA KHO", "arabic": "جَ حَ خَ"}, {"order_id": 13, "latin": "A BA TA TSA JA HA KHO DA DZA", "arabic": "أَ بَ تَ ثَ جَ حَ خَ دَ ذَ"}]
