...
def run_ocr():
    ...
    image_path = os.path.join(base_dir, "iqro-images", "1", "1-29.png")
    output_dir = os.path.join(base_dir, "iqro", "1")
    output_path = os.path.join(output_dir, "1-29.json")
    
    print(f"Reading image: {image_path}")
    reader = easyocr.Reader(['ar', 'en'], gpu=False)
    
    temp_image = "temp_1-29.png"
    ...
    iqro_data = {
        "level_id": 1,
        "level_title": "IQRO' 1",
        "topic": {"latin": "Latihan Gabungan Huruf", "arab": ""},
        "instruction_id": "",
        "instruction_en": "",
        "instruction_ar": "",
        "content": []
    ...
    reference_content = [{"order_id": 1, "latin": "TSA BA TA JA JA KHO DA ZA RA", "arabic": "ثَ بَ تَ جَ جَ خَ دَ ذَ رَ"}, {"order_id": 2, "latin": "ZA SA SYA A SHO ZHO THO AIN", "arabic": "زَ سَ شَ اَ صَ ظَ طَ عَ"}, {"order_id": 3, "latin": "GHA FA QOF KA LA MA NA WA HA", "arabic": "غَ فَ قَ كَ لَ مَ نَ و هَ"}, {"order_id": 4, "latin": "HA HA LA BA YI NA A A RA", "arabic": "حَ هَ لَ بَ ي نَ اَء اَ رَ"}, {"order_id": 5, "latin": "BA GHA TSA JA JA KHO DA ZA RA", "arabic": "بَ غَ ثَ جَ جَ خَ دَ ذَ رَ"}, {"order_id": 6, "latin": "ZA SA SYA A SHO DHOD THO ZHO AIN", "arabic": "زَ سَ شَ اَ صَ ضَ طَ ظَ عَ"}, {"order_id": 7, "latin": "GHA FA QOF KA LA MA NA WA HA", "arabic": "غَ فَ قَ كَ لَ مَ نَ و هَ"}, {"order_id": 8, "latin": "HA YI TA A KA LA MA RA NA WA", "arabic": "هَ ي تَ اَ كَ لَ مَ رَ نَ و"}]
