...
def run_ocr():
    ...
    image_path = os.path.join(base_dir, "iqro-images", "1", "1-5.png")
    output_dir = os.path.join(base_dir, "iqro", "1")
    output_path = os.path.join(output_dir, "1-5.json")
    
    print(f"Reading image: {image_path}")
    reader = easyocr.Reader(['ar', 'en'], gpu=False)
    
    temp_image = "temp_1-5.png"
    ...
    reference_content = [{"order_id": 1, "latin": "JA HA", "arabic": "جَ حَ"}, {"order_id": 2, "latin": "A JA HA", "arabic": "اَ جَ حَ"}, {"order_id": 3, "latin": "JA HA TSA", "arabic": "جَ حَ ثَ"}, {"order_id": 4, "latin": "JA HA BA TSA", "arabic": "جَ حَ بَ ثَ"}, {"order_id": 5, "latin": "JA HA BA", "arabic": "جَ حَ بَ"}, {"order_id": 6, "latin": "JA HA A BA", "arabic": "جَ حَ اَ بَ"}, {"order_id": 7, "latin": "JA HA TSA A", "arabic": "جَ حَ ثَ اَ"}, {"order_id": 8, "latin": "JA HA BA A", "arabic": "جَ حَ بَ اَ"}, {"order_id": 9, "latin": "JA HA A JA HA", "arabic": "جَ حَ اَ جَ حَ"}, {"order_id": 10, "latin": "A JA HA JA HA", "arabic": "اَ جَ حَ جَ حَ"}, {"order_id": 11, "latin": "A JA HA TSA", "arabic": "اَ جَ حَ ثَ"}, {"order_id": 12, "latin": "A JA HA BA TSA", "arabic": "اَ جَ حَ بَ ثَ"}, {"order_id": 13, "latin": "A BA TSA JA HA", "arabic": "اَ بَ ثَ جَ حَ"}]
