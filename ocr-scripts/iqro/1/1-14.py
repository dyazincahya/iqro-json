...
def run_ocr():
    ...
    image_path = os.path.join(base_dir, "iqro-images", "1", "1-14.png")
    output_dir = os.path.join(base_dir, "iqro", "1")
    output_path = os.path.join(output_dir, "1-14.json")
    
    print(f"Reading image: {image_path}")
    reader = easyocr.Reader(['ar', 'en'], gpu=False)
    
    temp_image = "temp_1-14.png"
    ...
    reference_content = [{"order_id": 1, "latin": "SHOD A DHOD", "arabic": "صَ اَ ضَ"}, {"order_id": 2, "latin": "HA DHOD RA", "arabic": "حَ ضَ رَ"}, {"order_id": 3, "latin": "A SHOD DHOD", "arabic": "اَ صَ ضَ"}, {"order_id": 4, "latin": "SYA A DHOD", "arabic": "شَ اَ ضَ"}, {"order_id": 5, "latin": "SYA KHO ZA", "arabic": "شَ خَ زَ"}, {"order_id": 6, "latin": "DHOD RA BA", "arabic": "ضَ رَ بَ"}, {"order_id": 7, "latin": "SHOD HA TA", "arabic": "صَ حَ ت"}, {"order_id": 8, "latin": "SHOD DA ZA", "arabic": "صَ دَ زَ"}, {"order_id": 9, "latin": "DA SYA DHOD", "arabic": "دَ شَ ضَ"}, {"order_id": 10, "latin": "SA HA ZA", "arabic": "سَ حَ زَ"}, {"order_id": 11, "latin": "RA SHOD DA", "arabic": "رَ صَ دَ"}, {"order_id": 12, "latin": "DHOD TA ZA", "arabic": "ضَ ت زَ"}, {"order_id": 13, "latin": "SYA KHO ZA", "arabic": "شَ خَ زَ"}, {"order_id": 14, "latin": "DHOD JA DA", "arabic": "ضَ جَ دَ"}, {"order_id": 15, "latin": "SA A SYA", "arabic": "سَ اَ شَ"}, {"order_id": 16, "latin": "SHOD RA DHOD", "arabic": "صَ رَ ضَ"}, {"order_id": 17, "latin": "A BA TA", "arabic": "اَ بَ ت"}, {"order_id": 18, "latin": "TA JA HA KHO", "arabic": "تَ جَ حَ خَ"}, {"order_id": 19, "latin": "KHO DA DA RO RO SA SYA SHOD DHOD", "arabic": "خَ دَ دَ رَ رَ سَ شَ ضَ"}]
