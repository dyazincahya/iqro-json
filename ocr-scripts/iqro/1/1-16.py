...
def run_ocr():
    ...
    image_path = os.path.join(base_dir, "iqro-images", "1", "1-16.png")
    output_dir = os.path.join(base_dir, "iqro", "1")
    output_path = os.path.join(output_dir, "1-16.json")
    
    print(f"Reading image: {image_path}")
    reader = easyocr.Reader(['ar', 'en'], gpu=False)
    
    temp_image = "temp_1-16.png"
    ...
    reference_content = [{"order_id": 1, "latin": "ZHO A THO", "arabic": "ظَ اَ طَ"}, {"order_id": 2, "latin": "BA THO ZHO", "arabic": "بَ طَ ظَ"}, {"order_id": 3, "latin": "THO HA ZA", "arabic": "طَ حَ زَ"}, {"order_id": 4, "latin": "SA SHOD ZHO", "arabic": "سَ صَ ظَ"}, {"order_id": 5, "latin": "DA SHOD ZHO", "arabic": "دَ صَ ظَ"}, {"order_id": 6, "latin": "THO HA ZA", "arabic": "طَ حَ زَ"}, {"order_id": 7, "latin": "SYA A ZHO", "arabic": "شَ اَ ظَ"}, {"order_id": 8, "latin": "SA RA SHOD", "arabic": "سَ رَ صَ"}, {"order_id": 9, "latin": "ZA KHO THO", "arabic": "زَ خَ طَ"}, {"order_id": 10, "latin": "TA RA SHOD", "arabic": "تَ رَ صَ"}, {"order_id": 11, "latin": "ZA KHO SHOD", "arabic": "زَ خَ صَ"}, {"order_id": 12, "latin": "TA SHOD ZHO", "arabic": "تَ صَ ظَ"}, {"order_id": 13, "latin": "SHOD DA SYA", "arabic": "صَ دَ شَ"}, {"order_id": 14, "latin": "JA THO DHOD", "arabic": "جَ طَ ضَ"}, {"order_id": 15, "latin": "SYA RA THO ZHO", "arabic": "شَ رَ طَ ظَ"}, {"order_id": 16, "latin": "A BA TA", "arabic": "اَ بَ تَ"}, {"order_id": 17, "latin": "TA JA HA KHO", "arabic": "تَ جَ حَ خَ"}, {"order_id": 18, "latin": "DA DA", "arabic": "دَ دَ"}, {"order_id": 19, "latin": "RA ZA RA SA SYA SHOD SHOD THO ZHO", "arabic": "رَ زَ رَ سَ شَ صَ صَ طَ ظَ"}]
