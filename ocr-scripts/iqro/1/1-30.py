...
def run_ocr():
    ...
    image_path = os.path.join(base_dir, "iqro-images", "1", "1-30.png")
    output_dir = os.path.join(base_dir, "iqro", "1")
    output_path = os.path.join(output_dir, "1-30.json")
    
    print(f"Reading image: {image_path}")
    reader = easyocr.Reader(['ar', 'en'], gpu=False)
    
    temp_image = "temp_1-30.png"
    ...
    iqro_data = {
        "level_id": 1,
        "level_title": "IQRO' 1",
        "topic": {"latin": "Membedakan Huruf", "arab": ""},
        "instruction_id": "PENTING",
        "instruction_en": "IMPORTANT: DISTINGUISH CLEARLY BETWEEN",
        "instruction_ar": "",
        "content": []
    }

    # Reference data for spelling alignment & layout correction
    reference_content = [{"order_id": 1, "latin": "A - AIN, TA - SA", "arabic": "اَ - عَ , ت - سَ"}, {"order_id": 2, "latin": "HA - HA, TSA - SYA", "arabic": "حَ - هَ , ثَ - شَ"}, {"order_id": 3, "latin": "JA - ZA, SA - SYA", "arabic": "جَ - زَ , سَ - شَ"}, {"order_id": 4, "latin": "YA - ZA, SA - SHO", "arabic": "يَ - زَ , سَ - صَ"}, {"order_id": 5, "latin": "KHO - AIN, TA - THO", "arabic": "خَ - عَ , ت - طَ"}, {"order_id": 6, "latin": "KHO - QOF, DA - ZHO", "arabic": "خَ - قَ , د - ظَ"}, {"order_id": 7, "latin": "GHA - QOF, ZHO - DHOD", "arabic": "غَ - قَ , ظَ - ضَ"}]
