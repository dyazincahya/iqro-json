...
def run_ocr():
    ...
    image_path = os.path.join(base_dir, "iqro-images", "1", "1-3.png")
    output_dir = os.path.join(base_dir, "iqro", "1")
    output_path = os.path.join(output_dir, "1-3.json")
    
    print(f"Reading image: {image_path}")
    reader = easyocr.Reader(['ar', 'en'], gpu=False)
    
    temp_image = "temp_1-3.png"
    ...
    iqro_data = {
        "level_id": 1,
        "level_title": "IQRO' 1",
        "topic": {"latin": "BA TA TSA", "arab": "بَ تَ ثَ"},
        "instruction_id": "",
        "instruction_en": "",
        "instruction_ar": "",
        "content": []
    ...
    reference_content = [{"order_id": 1, "latin": "BA TA TSA", "arabic": "بَ تَ ثَ"}, {"order_id": 2, "latin": "BA TSA TA", "arabic": "بَ ثَ تَ"}, {"order_id": 3, "latin": "TSA BA TA", "arabic": "ثَ بَ تَ"}, {"order_id": 4, "latin": "A BA TSA", "arabic": "اَ بَ ثَ"}, {"order_id": 5, "latin": "A TA TSA", "arabic": "اَ تَ ثَ"}, {"order_id": 6, "latin": "TSA TSA TA", "arabic": "ثَ ثَ تَ"}, {"order_id": 7, "latin": "BA TA BA", "arabic": "بَ تَ بَ"}, {"order_id": 8, "latin": "TSA BA TSA", "arabic": "ثَ بَ ثَ"}, {"order_id": 9, "latin": "TA BA TSA", "arabic": "تَ بَ ثَ"}, {"order_id": 10, "latin": "BA TSA BA", "arabic": "بَ ثَ بَ"}, {"order_id": 11, "latin": "A TSA BA", "arabic": "اَ ثَ بَ"}, {"order_id": 12, "latin": "TSA TSA TSA", "arabic": "ثَ ثَ ثَ"}, {"order_id": 13, "latin": "BA TSA TA TSA", "arabic": "بَ ثَ تَ ثَ"}, {"order_id": 14, "latin": "A BA TA TSA", "arabic": "اَ بَ تَ ثَ"}]
