...
def run_ocr():
    ...
    image_path = os.path.join(base_dir, "iqro-images", "2", "2-29.png")
    output_dir = os.path.join(base_dir, "iqro", "easyocr", "2")
    output_path = os.path.join(output_dir, "2-29.json")
    
    print(f"Reading image: {image_path}")
    reader = easyocr.Reader(['ar', 'en'], gpu=False)
    
    temp_image = "temp_2-29.png"
    ...
    reference_content = [
        ...
        {
                "latin": "HA HAAKHA QA GHA",
                "arabic": "ها حااخا قا غا"
        },
        {
                "latin": "GHA",
                "arabic": "غى"
