...
def run_ocr():
    ...
    reference_content = [
        {
                "latin": "BATA = BADA = BADA",
                "arabic": "بَتَ = بَ دَ = بَ دَ"
        },
        {
                "latin": "TAR = TAR = TARU = TARU",
                "arabic": "تَر = تَر = تَرَ وُ = تَر وُ"
        },
        {
                "latin": "TATA TADA TABA TAWU",
                "arabic": "تَتَ    تَدَ    تَبَ    تَوُ"
        },
        {
                "latin": "BABA BADZA BATA TAZA",
                "arabic": "بَبَ    بَذَ    بَتَ    تَزَ"
        },
        {
                "latin": "BATHA TADZA THATA ZATHA",
                "arabic": "بَثَ    تَذَ    ثَتَ    زَثَ"
        },
        {
                "latin": "BA'A BAATA TA'A TAATA",
                "arabic": "بَأَ    بَاتَ    تَأَ    تَاتَ"
        },
        {
                "latin": "THABA THARU BARU TAWA",
                "arabic": "ثَبَ    ثَرُ    بَرُ    تَوَ"
        },
        {
                "latin": "TOHA JAKA KAY JASA",
                "arabic": "طَهَ    جَكَ    كَى    جَسَ"
        }
]
