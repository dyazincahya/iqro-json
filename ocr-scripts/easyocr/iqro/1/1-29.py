...
def run_ocr():
    ...
    reference_content = [
        {
                "latin": "TSA BA TA JA JA KHO DA ZA RA",
                "arabic": "ثَ بَ تَ جَ جَ خَ دَ ذَ رَ"
        },
        {
                "latin": "ZA SA SYA A SHO ZHO THO AIN",
                "arabic": "زَ سَ شَ اَ صَ ظَ طَ عَ"
        },
        {
                "latin": "GHA FA QOF KA LA MA NA WA HA",
                "arabic": "غَ فَ قَ كَ لَ مَ نَ و هَ"
        },
        {
                "latin": "HA HA LA BA YI NA A A RA",
                "arabic": "حَ هَ لَ بَ ي نَ اَء اَ رَ"
        },
        {
                "latin": "BA GHA TSA JA JA KHO DA ZA RA",
                "arabic": "بَ غَ ثَ جَ جَ خَ دَ ذَ رَ"
        },
        {
                "latin": "ZA SA SYA A SHO DHOD THO ZHO AIN",
                "arabic": "زَ سَ شَ اَ صَ ضَ طَ ظَ عَ"
        },
        {
                "latin": "GHA FA QOF KA LA MA NA WA HA",
                "arabic": "غَ فَ قَ كَ لَ مَ نَ و هَ"
        ...
        {
                "latin": "HA YI TA A KA LA MA RA NA WA",
                "arabic": "هَ ي تَ اَ كَ لَ مَ رَ نَ و"
        }
]
