...
def run_ocr():
    ...
    image_path = os.path.join(base_dir, "iqro-images", "1", "1-31.png")
    output_dir = os.path.join(base_dir, "iqro", "easyocr", "1")
    output_path = os.path.join(output_dir, "1-31.json")
    
    print(f"Reading image: {image_path}")
    reader = easyocr.Reader(['ar', 'en'], gpu=False)
    
    temp_image = "temp_1-31.png"
    ...
    reference_content = [
        {
                "latin": "TA TSA JA HA KHO DA DZA RO ZA",
                "arabic": "تَ ثَ جَحَ خَ دَ ذَ رَزَ"
        },
        {
                "latin": "SA",
                "arabic": "سَ"
        ...
        {
                "latin": "DHO THO A ZHO  'A GHO",
                "arabic": "ضَ طَاَ ظَعَ غَ"
        },
        {
                "latin": "FA QO KA DA MA NA WA HA A YA",
                "arabic": "فَقَكَدَمَنَ وَهَءَ يَ"
        },
        {
                "latin": "YA",
                "arabic": "يَ"
        ...
        {
                "latin": "HA WA NA MA LA A KA QO",
                "arabic": "هَ وَنَ مَ لَاَكَ قَ"
        },
        {
                "latin": "FA",
                "arabic": "فَ"
        ...
        {
                "latin": "TA GHO  'A ZHO A THO DHO SHO",
                "arabic": "تَغَعَ ظَاَطَ ضَ صَ"
        },
        {
                "latin": "SA",
                "arabic": "سَ"
        ...
        {
                "latin": "ZA RO DZA DA KHO HA JA TSA TA BA A",
                "arabic": "زَ رَذَ دَخَحَ جَ ثَ تَ بَاَ"
        }
]
