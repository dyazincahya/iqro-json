...
def run_ocr():
    ...
    reference_content = [
        ...
        {
                "latin": "A SA ZA RA SA",
                "arabic": "أَ سَ زَ رَ سَ"
        },
        {
                "latin": "SA KHO DZA KHO SA DA",
                "arabic": "سَ خَ ذَ خَ سَ دَ"
        },
        {
                "latin": "SA KHO TSA JA ZA RA",
                "arabic": "سَ خَ ثَ جَ زَ رَ"
        },
        {
                "latin": "SA BA TA DZA RA SA",
                "arabic": "سَ بَ تَ ذَ رَ سَ"
        },
        {
                "latin": "SA KHO DZA KHO DZA DA",
                "arabic": "سَ خَ ذَ خَ ذَ دَ"
        },
        {
                "latin": "SA KHO TSA DA TSA DA",
                "arabic": "سَ خَ ثَ دَ ثَ دَ"
        },
        {
                "latin": "SA KHO TSA A BA TA",
                "arabic": "سَ خَ ثَ أَ بَ تَ"
        },
        {
                "latin": "TSA KHO TSA KHO DZA DZA RA ZAI SA",
                "arabic": "ثَ خَ ثَ خَ ذَ ذَ رَ زَ سَ"
        },
        {
                "latin": "SA KHO TSA BA TA DA",
                "arabic": "سَ خَ ثَ بَ تَ دَ"
        },
        {
                "latin": "SA KHO TSA TSA KHO SA",
                "arabic": "سَ خَ ثَ ثَ خَ سَ"
        },
        {
                "latin": "SA KHO DZA DZA SA RA",
                "arabic": "سَ خَ ذَ ذَ سَ رَ"
        },
        {
                "latin": "TSA ZA HA KHO DA DZA RA ZAI SA",
                "arabic": "ثَ زَ حَ خَ دَ ذَ رَ زَ سَ"
        }
]
