...
def run_ocr():
    ...
    image_path = os.path.join(base_dir, "iqro-images", "1", "1-1.png")
    output_dir = os.path.join(base_dir, "iqro", "easyocr", "1")
    output_path = os.path.join(output_dir, "1-1.json")
    
    print(f"Reading image: {image_path}")
    reader = easyocr.Reader(['ar', 'en'], gpu=False)
    
    temp_image = "temp_1-1.png"
    ...
    # The exact content from the image, read Top-to-Bottom, Right-to-Left
    reference_content = [
        {"latin": "A = A", "arabic": "أَ = أَ"},
        {"latin": "A BA", "arabic": "أَ بَ"},
        {"latin": "BA A BA", "arabic": "بَ اَ بَ"},
        {"latin": "A BA A", "arabic": "اَ بَ اَ"},
        {"latin": "BA A A", "arabic": "بَ اَ اَ"},
        {"latin": "A A BA", "arabic": "اَ اَ بَ"},
        {"latin": "BA BA A", "arabic": "بَ بَ اَ"},
        {"latin": "A BA BA", "arabic": "اَ بَ بَ"},
        {"latin": "BA A BA", "arabic": "بَ اَ بَ"},
        {"latin": "A BA A", "arabic": "اَ بَ اَ"},
        {"latin": "A A A", "arabic": "اَ اَ اَ"},
        {"latin": "BA BA BA", "arabic": "بَ بَ بَ"},
        {"latin": "A BA", "arabic": "اَ بَ"},
        {"latin": "A BA", "arabic": "اَ بَ"}
    ]
    ...
    iqro_data = {
        ...
        "instruction_id": instruction_id if instruction_id else "Bacaan langsung A Bacalah dengan suara pendek Ba dst: Tidak perlu diurai/dieja.",
    ...
    order_id = 1
    ref_idx = 0
    for r_idx, r in enumerate(calligraphy_rows):
        row_val = r_idx + 1
        for c_idx, b in enumerate(r):
            ...
            if ref_idx < len(reference_content):
                latin_text = reference_content[ref_idx]["latin"]
                arabic_text = reference_content[ref_idx]["arabic"]
                ref_idx += 1
            else:
